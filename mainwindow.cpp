...
void MainWindow::on_checkBoxsearchabnt_2_stateChanged(int arg1)
{
    Abonement s ;
...
void MainWindow::on_checkBoxsearchabnt_3_stateChanged(int arg1)
{
    Abonement s ;
...
void MainWindow::on_b_note_clicked() {
    ...
    if (query.exec() && query.next()) {
        ...
        if (note.toInt() < 20) {
            ui->label_message->setText("<font color='red'>Réévaluation recommandée pour cet abonné.</font>");
        } else {
            ui->label_message->setText("<font color='green'>L'abonné est respectueux.</font>");
        }
