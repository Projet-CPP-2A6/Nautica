...
bool Employes::ajouter() {
  ...
  query.prepare("INSERT INTO "
                "EMPLOYES(CIN,NOM,PRENOM,GENRE,TELEPHONE,EMAIL,ADRESSE,"
                "FONCTION,SALAIRE,RFID)"
                "VALUES "
                "(:CIN,:NOM,:PRENOM,:GENRE,:TELEPHONE,:EMAIL,:ADRESSE,:"
                "FONCTION,:SALAIRE,:RFID)");
...
bool Employes::modifier() {
  ...
  query.prepare(
      ...
      "FONCTION=:FONCTION, SALAIRE=:SALAIRE, RFID=:RFID WHERE CIN = :CIN ");
  query.bindValue(":CIN", CIN);
  query.bindValue(":NOM", nom);
  query.bindValue(":PRENOM", prenom);
  query.bindValue(":GENRE", genre);
